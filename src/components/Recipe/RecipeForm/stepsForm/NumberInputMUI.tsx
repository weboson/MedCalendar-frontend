// Универсальный Input Number от MUI, который принимает только числа
// Численный input в Material-UI двольно сложно реализуется, поэтому так много кода и импортов

import React from "react";
// импорты скопировал с примера:  https://mui.com/base-ui/react-number-input/#customization
import {
...
const NumberInputMUI = React.forwardRef(function CustomNumberInput(
